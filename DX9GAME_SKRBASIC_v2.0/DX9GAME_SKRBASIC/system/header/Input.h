...
namespace skrBasic {
	...
	public:
		...
		static bool isKeyInput(int key);

		//キーを押しているか
		//@param key キーID
		//@return 押している間は true を返す
		static bool isKeyInput(KeyboardInput key);

		//キーを押した瞬間か
		//@param key キーID(DIK_*)
		//@return 押した瞬間は true を返す
		static bool isKeyPush(int key);

		//キーを押した瞬間か
		//@param key キーID
		//@return 押した瞬間は true を返す
		static bool isKeyPush(KeyboardInput key);
		...
		//@param key キーID
		//@return 離した瞬間は true を返す
		static bool isKeyRelease(KeyboardInput key);
		...
		//@param button ボタンID
		//@return 押している間は true を返す
		static bool isJoypadInput(JoypadInput button);

		//ゲームパッドのボタンを押した瞬間か
		//@param button ボタンID
		//@return 押した瞬間は true を返す
		static bool isJoypadPush(JoypadInput button);

		//ゲームパッドのボタンを離した瞬間か
		//@param button ボタンID
		//@return 離した瞬間は true を返す
		static bool isJoypadRelease(JoypadInput button);




		//マウスボタンを押しているか
		//@param mousebutton マウスボタンID
		//@return 押している間は true を返す
		static bool isMouseInput(MouseInput mousebutton);

		//マウスボタンを押した瞬間か
		//@param mousebutton マウスボタンID
		//@return 押した瞬間は true を返す
		static bool isMouseClick(MouseInput mousebutton);

		//マウスボタンを離した瞬間か
		//@param mousebutton マウスボタンID
		//@return 離した瞬間は true を返す
		static bool isMouseRelease(MouseInput mousebutton);
		...
		//@param area 判定する範囲
		//@return 押している間は true を返す
		static bool isMouseInputInRange(MouseInput mousebutton, const RECT *area);

		//特定範囲内でマウスボタンを押した瞬間か
		//@param mousebutton マウスボタンID
		//@param area 判定する範囲
		//@return 押した瞬間は true を返す
		static bool isMouseClickInRange(MouseInput mousebutton, const RECT *area);

		//特定範囲内でのマウスボタンを離した瞬間か
		//@param mousebutton マウスボタンID
		//@param area 判定する範囲
		//@return 離した瞬間は true を返す
		static bool isMouseReleaseInRange(MouseInput mousebutton, const RECT *area);


		//マウス(カーソル)が特定範囲内にあるか
		//@param area 判定する範囲
		static bool isMouseInRange(const RECT *area);
